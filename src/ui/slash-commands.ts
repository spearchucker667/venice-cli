...
export const SLASH_COMMANDS: SlashCommandDefinition[] = [
  ...
  { name: 'clear', description: 'Clear conversation and start a fresh session', availability: 'idle' },
  ...
  { name: 'model', aliases: ['models'], description: 'Show model picker or set a model', availability: 'idle' },
  { name: 'resume', description: 'Resume a session', availability: 'idle' },
  { name: 'sessions', description: 'List saved sessions', availability: 'always' },
  { name: 'delete', description: 'Delete a saved session by id (see /sessions)', availability: 'idle' },
  ...
  { name: 'plan', description: 'Toggle plan mode', availability: 'idle' },
  { name: 'plan on', aliases: [], description: 'Enable plan mode', availability: 'idle' },
  { name: 'plan off', aliases: [], description: 'Disable plan mode', availability: 'idle' },
  ...
  { name: 'theme', description: 'Change the UI theme', availability: 'idle' },
  ...
  { name: 'skill', description: 'Load a skill by name (e.g. /skill release)', availability: 'idle' },
  { name: 'permissions', description: 'Show or change approval mode', availability: 'idle' },
  ...
  { name: 'new', description: 'Start a fresh conversation', availability: 'idle' },
  { name: 'fork', description: 'Fork the current session', availability: 'idle' },
  ...
  { name: 'import', description: 'Import a session file', availability: 'idle' },
];
